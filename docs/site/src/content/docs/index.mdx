...
<CardGrid>
  ...
  <Card title="Network + Protect" icon="puzzle">
    62 Network tools plus 11 opt-in Protect tools. Network on by default; Protect via `MCP_UNIFI_MODULES_ENABLED=network,protect`.
  </Card>
